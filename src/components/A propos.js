    ...
    <div className="about-page">
      ...
      <header className="about-header about-header-1">
        <div className="banner-content">
          <h1 className="about-title">À propos de Pharmacie Healthy Care</h1>
        </div>
      </header>
