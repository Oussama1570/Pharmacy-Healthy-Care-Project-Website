          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-12" >
                <h2 className="home-title">Bienvenue à la Pharmacie Healthy Care</h2>
                <p className="home-subtitle">Votre santé, notre priorité.</p>
                <p className="home-description">
                  Chez la Pharmacie Healthy Care, votre santé est notre priorité. Nous nous engageons à vous offrir des soins de qualité, adaptés à vos besoins, dans un environnement accueillant et professionnel.
                </p>
                <p className="home-description">
  ...
  <div className="container">
    <div className="section-header">
      ...
      <p className="section-description">
        Découvrez les services de qualité offerts par la Pharmacie Healthy Care. Nous mettons un point d'honneur à prendre soin de votre santé avec des solutions personnalisées et adaptées à vos besoins.
      </p>
    </div>
